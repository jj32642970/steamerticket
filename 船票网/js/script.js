$(document).ready(function(){
	...
	// 船票价格下拉列表
	var priceListHtml =
	'<select name="price"><option value="315">普通 ￥315</option><option value="300">学生 ￥300</option><option value="270">军人 ￥270</option><option value="100">儿童 ￥100</option></select>';
	
	// 证件类型下拉列表
	var certTypeHtml =
	'<select name="certType"><option value="1">身份证</option><option value="2">军人证</option><option value="3">港澳台通行证</option><option value="4">其他证件</option></select>';
